...
import se.callista.microservises.support.discovery.model.Recommendation;
import se.callista.microservises.support.discovery.model.Review;
...
public class ProductCompositeIntegration {
    ...
    public Product getProduct(int productId) {
        ...
        Product prd = restTemplate.getForObject(url, Product.class);
...
//        System.out.println("GetProduct.id: {}" + product.getProductId());
    ...
    public Product defaultProduct(int productId) {
        ...
        return new Product(1,"default",1);
    }
